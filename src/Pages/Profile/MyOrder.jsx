...
const MyOrder = () => {
  ...
  <TabsList className='w-full flex gap-5'>
    <TabsTrigger className='w-1/2 text-[#000] font-bold text-3xl hover:bg-pink-300 rounded-full '  value="active">Active Orders</TabsTrigger>
    <TabsTrigger className='w-1/2 text-[#000] font-bold text-3xl hover:bg-pink-300 rounded-full ' value="previous">Previous Orders</TabsTrigger>
  </TabsList>
